                    ...
                    for page in range(1, pages + 1):
                        ...
                        for n in names:
                            ...
                            try:
                                ...
                                abc = 'ch.', 'gr.', 'b.', 'br.', 'blk.', 'dkb/br.', 'blk/br.', '1955'
                                ...
                                for m in table.find_elements_by_class_name('m'):
                                    if m.text.startswith(abc):
                                        continue
                                    male.append((m.get_attribute('data-g'), m.text.replace('\n', '')))

                                for f in table.find_elements_by_class_name('f'):
                                    if f.text.startswith(abc):
                                        continue
                                    female.append((f.get_attribute('data-g'), f.text.replace('\n', '')))
